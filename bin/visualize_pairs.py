...
#         # axes[2].patches[j+i*8].set_fill(fill[i])
...
opp_bar = axes[2].bar(x-barWidth/2, logOddsOpp, yerr=y_r_opp, width=barWidth, color=['g', 'r', 'g', 'g', 'r', 'r', 'g', 'r'], edgecolor="black", alpha=1.0, align='center', label='Opp charge')
same_bar = axes[2].bar(x+barWidth/2, logOddsSame, yerr=y_r_same, width=barWidth, color=['g', 'r', 'g', 'g', 'r', 'r', 'g', 'r'], edgecolor="black", alpha=1.0, align='center', label='Same charge')
...
axes[4].bar(x, frac_data, alpha=1.0,edgecolor="black", )
...
plt.text(-0.05, 1.10, "a)", fontsize=16, transform=axes[2].transAxes)
