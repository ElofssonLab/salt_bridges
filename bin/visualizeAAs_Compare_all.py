...
parser.add_argument("glob", type=str, help="In glob pickle")
parser.add_argument("mems", type=str, help="In membrane pickle")
...
for i in range(7):
    for first in range(20):
        for second in range(20):
            ...
            # else:
            std_err = math.sqrt(1/1 + 1/b + 1/c + 1/d)
...
chart = sns.clustermap(df, row_cluster=True, col_cluster=False, figsize=(36, 10), cmap="coolwarm", center=0,
